...
const PersonnelManagement = ({
    ...
    let { feedbackData, pagination, searchList } = personnelManagement;
        ...
        },
        {
            ...
            render: (text, record) => {
                return (
                    <div>
                        <Fragment>
                            <a onClick={showModal.bind(this, { feedbackId: record.feedbackId, isProcessed: record.isProcessed, remark: record.descriptionAndRemark.remark })}></a>
                        </Fragment>
                    </div>
                );
            }
...
export default connect(({ personnelManagement, loading }) => ({
    personnelManagement,
    loading: loading.models.personnelManagement
}))(Form.create()(PersonnelManagement));
