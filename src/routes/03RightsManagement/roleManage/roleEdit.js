...
const RoleEdit = ({
    ...
    const deviceOnChange = (checkList) => {
        dispatch({
            type: "roleEdit/setDevice", payload: {
                checkList: checkList,
    ...
    const feedbackOnChange = (checkList) => {
        dispatch({
            type: "roleEdit/setFeedback", payload: {
                checkList: checkList,
    ...
    const submit = () => {
        ...
        message.loading("正在更新角色数据,请稍后!!").then(() => {
